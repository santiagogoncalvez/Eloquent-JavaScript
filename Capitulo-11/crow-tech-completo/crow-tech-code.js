// Codigo completo de crew tech
import { bigOak, everywhere, defineRequestType } from "./crow-tech-ESModule.mjs";
...
console.log("Keys: ", bigOak.state.connections.keys());      //
console.log("Size: ", bigOak.state.connections.size);         // 1
...
setTimeout(() => {
    ...
    console.log("Node Big Oak ", bigOak)
}, 3000);