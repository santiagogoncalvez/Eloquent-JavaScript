...
async function connectionsSize() {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            resolve(bigOak.state.connections.size);
        }, 1000)
    })
}


let size1 = bigOak.state.connections.size;
let size2;
connectionsSize().then(result => size2 = result)
...
const server = http.createServer((req, res) => {
    ...
    console.log("Tamanio de las conexiones ANTES del proceso de datos: ", '${size1}'); 
    setTimeout(() => {
        console.log("Tamanio de las conexiones DESPUES del proceso de datos: ",'${size2}') }, 4000
        );
