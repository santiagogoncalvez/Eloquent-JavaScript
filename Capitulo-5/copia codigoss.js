...
var SCRIPTS = [
  ...
  console.log(SCRIPTS.reduce((a, b) => { return cuentaCaracteres(a) < cuentaCaracteres(b) ? b : a }));
  ...
  function ponderacion (cantElementos) {
    ...
    for (let i = 0; i < cantElementos-1; i++) {
  ...
  let ponderaciones = ponderacion(139);
